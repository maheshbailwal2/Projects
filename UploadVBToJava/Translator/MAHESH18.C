	...
	s[i]=c;
		...
		s[i]='\0';
						  ...
						  if ((strcmp( s,"List"))==0  )
		 {
			 ...
			 if ((strcmp( s,"Begin"))==0  )
		 {
			//printf("add--%u mahesh",&(temp->child));
				  //	getch();
			readframe(&f1,&(temp->child));

			//printf("#%s",temp->child->name);
