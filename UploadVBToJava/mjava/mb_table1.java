  ...
  class mb_table1 extends JFrame
 {
	...
	{
	mb_table1 ff=new mb_table1();
	ff.setLocation(100,50);
	ff.show();
	}
 }
...
scroll1.setBounds(50,100,550,200);
...
//this.add(mytable);
	 ...
	 Combo1.setBounds(100,50,100,21);
	  Combo1.setEditable(true);
	this.add(Combo1);
	 Command2 = new JButton("Command2");
	 Command2.setBounds(220,50,100,41);
	this.add(Command2);
	 Command1 = new JButton("Command1");
	 Command1.setBounds(320,50,100,33);
	this.add(Command1);
	 Text1 = new TextField("Text1");
	 Text1.setBounds(420,50,193,33);
	this.add(Text1);
	}
...
public static Vector getColumnNames(ResultSet results) throws SQLException{
  ...
  public static Vector getRows(ResultSet results) throws SQLException{
      ...
      while (results.next()){
         ...
         for (int i = 1; i <= columnCount; i++){
//          JOptionPane.showMessageDialog(null,Long.toString(metaData.getColumnType(i)));
			...
			{
               row.add(new Boolean(results.getBoolean(i)));
