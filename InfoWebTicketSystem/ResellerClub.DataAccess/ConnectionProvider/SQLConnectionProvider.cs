...
namespace ResellerClub.DataAccess.ConnectionProvider
{
   public  class SQLConnectionProvider : IConnection,IDisposable
    {
        ...
        /// 
        /// </summary>
        internal  SQLConnectionProvider(string connectionString)
        {
        ...
        public void OLDAddParameter(SqlParameter parameter)
        {
        ...
        public void OldAddParameter(string field, object fieldValue, SqlDbType sqlDbType, byte precision, byte scale, ParameterDirection parameterDirection)
        {
        ...
        /// <param name="parameterDirection"></param>
        public void OLDAddParameter(string field, object fieldValue, SqlDbType sqlDbType, int size, ParameterDirection parameterDirection)
        {
        ...
        public void AddParameter(string parametrName, object parametrvalue, ParameterDirection parameterDirection)
        {
            throw new NotImplementedException();
        }
