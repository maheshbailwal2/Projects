...
sealed class ParserLanguageSetting
{
    ...
    {
        languageSetting = new Dictionary<string, string>(20);
        ...
        foreach (XmlNode node in list)
        {
            ...
            if(node.Attributes["ComplilerKeyWord"] != null && node.Attributes["ComplilerKeyWord"].Value.Trim() != "")
            languageSetting.Add(node.Attributes["ComplilerKeyWord"].Value, node.Attributes["DisplayString"].Value);
        }
    }
