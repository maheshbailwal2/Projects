<%@ Page Language="C#" MasterPageFile="~/MasterPage/Main.Master" AutoEventWireup="true" CodeBehind="LinuxHostingPlan.aspx.cs"
    Inherits="ResellerClub.WebUI.LinuxHostingPlan" EnableEventValidation="false"
    ValidateRequest="false" Title="Linux Hosting" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div id="divHeaderText" runat="server" visible="false">
        Powerful <span>Linux Hosting</span>
    </div>
    ...
    <div id="divHeaderImage" runat="server" visible="false">
        <div style="padding-left: 250px;">
            <img src="../images/linux-server.png" />
        </div>
    </div>
</asp:Content>
